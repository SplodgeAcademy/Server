class Api::V1::WordFormationsController < ApiController
    ...
    def index
        ...
        # Return all word formations
        render json: @word_formations
    end
    ...
    def update
        respond_to do |format|
            if @word_formation.update(word_formation_params)
                format.html { redirect_to @word_formation, notice: "Word formation was successfully updated.", status: :see_other }
    ...
    def destroy
        ...
        respond_to do |format|
            format.html { redirect_to word_formations_path, notice: "Word formation was successfully destroyed.", status: :see_other }
