class Api::V1::OpenClozesController < ApiController
    ...
    def update
        respond_to do |format|
            if @open_cloze.update(open_cloze_params)
                format.html { redirect_to @open_cloze, notice: "Open cloze was successfully updated.", status: :see_other }
    ...
    def destroy
        ...
        respond_to do |format|
            format.html { redirect_to open_clozes_path, notice: "Open cloze was successfully destroyed.", status: :see_other }
